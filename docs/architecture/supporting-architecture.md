...
* **Messaging:** WhatsApp Cloud API for check-ins, verification, and caregiver alerts.
...
* The system first sends a gentle WhatsApp check-in to the senior.
...
* Alerts arrive through WhatsApp, providing the behavioural context behind the alert and suggesting a simple next action.
...
* **Data Scope:** The system only analyses interactions directly between the senior and Nomi, ignoring all unrelated WhatsApp conversations.

## 6. Target Personas
Development should be anchored to the defined primary and secondary users:
* **Primary Persona (Mdm Tan, 72):** An independent senior who uses WhatsApp, wants to age in place without being a burden, and is hesitant to constantly ask for help.
